...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-4 md:container shadow-xl md:mx-auto my-5 rounded-xl p-5 bg-slate-300 min-h-[80vh] md:w-[35%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-3">
          ...
          <div className="flex">
            ...
            <button
             ...
             mx-2
             p-4 py-2 text-sm font-bold text-white rounded-md"
            >
              Save
            </button>
          </div>
